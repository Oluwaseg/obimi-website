    ...
    <div className='bg-background min-h-screen'>
      ...
      <section className='relative py-24 px-6 md:px-12 lg:px-24 overflow-hidden'>
        ...
        <div className='container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          <div className='space-y-8'>
            ...
            <p data-aos='fade-up' data-aos-delay='200' className='text-2xl text-foreground font-sans leading-relaxed font-medium'>
              {t('heroDescription')}
            </p>
            <div data-aos='fade-up' data-aos-delay='300' className='p-6 border-l-4 border-primary bg-muted/30 rounded-r-3xl'>
          ...
          <div className='relative'>
            <div data-aos='zoom-in' className='aspect-square rounded-[4rem] overflow-hidden shadow-2xl border-8 border-background rotate-3 hover:rotate-0 transition-transform duration-500'>
              <img
            ...
            {/* Floating Badge */}
            <div data-aos='fade-left' data-aos-delay='400' className='absolute -bottom-8 -left-8 bg-accent text-accent-foreground p-8 rounded-[2.5rem] shadow-xl max-w-[240px] -rotate-6'>
        ...
        <div className='container mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {supportBlocks.map((block, index) => (
              <div
                key={index}
                data-aos='fade-up' data-aos-delay={index * 100} className='group p-8 rounded-[3rem] bg-background border border-border/50 hover:border-primary/30 hover:shadow-xl transition-all duration-300 flex flex-col items-center text-center space-y-6'
              >
                <div
      ...
      <section className='py-24 px-6 md:px-12 lg:px-24 relative overflow-hidden'>
        <div className='container mx-auto max-w-4xl text-center space-y-12 relative z-10'>
          <div data-aos='zoom-in' className='w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-8'>
            <Heart className='w-12 h-12 text-primary fill-primary/20' />
          </div>
          <h2 data-aos='fade-up' data-aos-delay='200' className='text-3xl md:text-4xl font-heading font-bold text-foreground leading-relaxed'>
            "{t('closingMessage')}"
          </h2>
        </div>
        {/* Decorative Blobs */}
      ...
      <section className='py-24 px-6 md:px-12 lg:px-24 bg-secondary text-white rounded-t-[5rem] md:rounded-t-[10rem]'>
        <div className='container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          <div className='space-y-8'>
            <h2 data-aos='fade-right' className='text-4xl md:text-6xl font-heading font-bold'>
              {t('visionTitle')}
            </h2>
            <p data-aos='fade-right' data-aos-delay='200' className='text-xl md:text-2xl text-white/80 font-sans leading-relaxed'>
              {t('visionDescription')}
            </p>
          ...
          <div className='grid grid-cols-2 gap-4'>
            <div data-aos='fade-up' data-aos-delay='300' className='aspect-[3/4] rounded-3xl overflow-hidden mt-12'>
              <img
            ...
            <div data-aos='fade-up' data-aos-delay='400' className='aspect-[3/4] rounded-3xl overflow-hidden'>
              <img
